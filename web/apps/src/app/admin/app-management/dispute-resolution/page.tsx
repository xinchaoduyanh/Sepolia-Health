...
export default function DisputeResolutionPage() {
    ...
    const { data: activeTerms, isLoading, refetch } = useAppTermsByType(AppTermsType.DISPUTE_RESOLUTION)
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-bold">Chính sách giải quyết khiếu nại, tranh chấp</h1>
                    <p className="text-muted-foreground mt-2">Quản lý chính sách giải quyết khiếu nại và tranh chấp</p>
                </div>
