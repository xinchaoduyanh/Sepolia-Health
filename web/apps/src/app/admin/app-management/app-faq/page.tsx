...
export default function AppFaqPage() {
    ...
    const { data: activeTerms, isLoading, refetch } = useAppTermsByType(AppTermsType.APP_FAQ)
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-bold">Hỏi đáp về ứng dụng</h1>
                    <p className="text-muted-foreground mt-2">Quản lý câu hỏi thường gặp về ứng dụng Sepolia Health</p>
                </div>
            ...
            <Card>
                <CardHeader>
                    <CardTitle>Nội dung hỏi đáp</CardTitle>
                    <CardDescription>
                        {activeTerms && (
                            <>
                ...
                <CardContent className="space-y-4">
                    <div className="space-y-2">
                        ...
                        <InputField
                            ...
                            disabled={!isEditing}
                            placeholder="Nhập tiêu đề hỏi đáp"
                        />
                    </div>
                    <div className="space-y-2">
                        ...
                        <TextareaField
                            ...
                            disabled={!isEditing}
                            placeholder="Nhập nội dung hỏi đáp (HTML hoặc markdown)"
