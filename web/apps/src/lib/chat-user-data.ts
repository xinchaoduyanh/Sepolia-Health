import type { MessageResponse, Channel as StreamChannel } from 'stream-chat'
...
export async function getWebChatUserInfo(
    ...
    if (targetUserId === 'sepolia-health-ai-assistant') {
        return {
            name: 'Trợ lý Y tế Thông minh',
            image: 'https://do-an-tot-nghiep-ptit.s3.ap-southeast-1.amazonaws.com/patient-avatars/612-727-1763463617117.jpg',
            userId: targetUserId,
        }
    }
