    ...
    return (
        <div className="flex items-center justify-center space-x-1">
            <Button
                ...
                onClick={() => (window.location.href = `/dashboard/article-management/${article.id}`)}
            >
        ...
        cell: ({ getValue }: { getValue: () => any }) => {
            ...
            return (
                <div className="max-w-sm">
                    <span className="text-muted-foreground text-sm line-clamp-3">{content}</span>
                </div>
            )
        },
    },
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-bold text-foreground">Quản lý danh sách bài viết</h1>
                    <p className="text-sm text-muted-foreground mt-1">Quản lý thông tin bài viết trong hệ thống</p>
                </div>
                <Button
                    className="flex items-center space-x-2"
                    onClick={() => (window.location.href = '/dashboard/article-management/create')}
                >
